...
- `scout_report`: Reveals monster weaknesses, resistances, and immunities, while keeping tool mechanics mostly implicit. This tests whether the agent can infer the right tool from monster information and natural-language tool descriptions.
